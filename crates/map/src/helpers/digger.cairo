...
pub impl Digger of DiggerTrait {
    #[inline]
    fn dig(width: u8, height: u8, start: u8, grid: felt252, mut seed: felt252) -> felt252 {
...
mod tests {
    ...
    fn test_digger_dig() {
        ...
        let walk: felt252 = Digger::dig(width, height, 35, grid, SEED);
        assert_eq!(walk, 0x7F003F800FB001FC003C481F1F0FFFE1EEF83FFE3FFF89FFEE3FF80000);
    }
}
