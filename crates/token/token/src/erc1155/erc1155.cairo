#[starknet::contract]
mod ERC1155 {
    use origami_token::erc1155::models::{ERC1155Meta, ERC1155OperatorApproval, ERC1155Balance};
    use origami_token::erc1155::interface;
    use origami_token::erc1155::interface::{IERC1155, IERC1155CamelOnly};
